...
$(document).ready(function () {  
    ...
    let table =  $('#table_old_documents').DataTable({ 
        'columnDefs': [ {
        ...
        //     $("#table_old_documents thead").remove(); 
        // },
    ...
    $("#btn-delete").click(function(e){
        ...
        let nodes = table.rows(".selected").nodes();
        let id_list = [];
        if(nodes.length > 0){
            ...
            $.ajax({
                ...
                success: (data) =>{
                    ...
                    .html(data.html_form)
                    .find(".modal-body")
                    .html(`<p>Are your sure you want to delete this <b>${id_list.length}</b> documents permanently?</p>`);
                },
                complete: (data) => {
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">No documents/records selected</h4>
            </div>
            <div class="modal-body">
                <p>Please select the documents you want to <b>delete</b> permanently!</p>
            </div>
    ...
    $("#modal-default").on("submit",".delete-documents-permanently", function(e){
        e.preventDefault();
        let form = $(this);
