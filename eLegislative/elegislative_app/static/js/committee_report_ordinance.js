$(document).ready(function () {
    ...
    $("#table_committee_report_ordinance").on("click", '.delete', function (e) {
        e.preventDefault();
      ...
      $("#modal-default").on("submit",".delete-committee-ordinance-report-form", function(e){
        e.preventDefault();
        let form = $(this);
        ...
        $.ajax({
            ...
            success: (data) => {
                if(data.form_is_valid){
                    ...
                    table_committee_report_ordinance.row(row).remove().draw();
                }else{
